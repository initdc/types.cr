...
describe Result do
  ...
  it "new" do
    expect_raises(Result::WrapingNil) { Ok(Nil, Nil)[nil] }
    expect_raises(Result::WrapingNil) { Err(Nil, Nil)[nil] }
    expect_raises(Result::WrapingNil) { Ok(Bool?, String?)[nil] }
    expect_raises(Result::WrapingNil) { Err(Bool?, String?)[nil] }
  end
