...
describe Option do
  ...
  it "new" do
    expect_raises(Option::WrapNil) { Some[nil] }
    expect_raises(Option::WrapNil) { None(Nil)[] }
    expect_raises(Option::WrapNil) { Some(Bool?)[false] }
  ...
  it "from" do
    ...
    expect_raises(Option::WrapNil) { Option.from?(nil) }
